...
A third paragraph if needed.`, tr: `Biyografinizi veya sanatçı beyanınızı buraya yazın. Kim olduğunuzu, nereden geldiğinizi, ne ürettiğinizi ve neden.
...
A new stanza begins after a blank line.`, tr: `Şiir metninizi buraya ekleyin.
Her satır sonu korunur.

Boş satırdan sonra yeni kıta başlar.`} }, { id:    'poem-2', title: { en: 'Poem Title Two', tr: 'Şiir Başlık İki' }, year:  2024, body: { en:`Second poem goes here.
Add as many lines as you like.`, tr: `İkinci şiir buraya gelir.
İstediğiniz kadar satır ekleyebilirsiniz.`} }, { id:    'poem-3', title: { en: 'Poem Title Three', tr: 'Şiir Başlık Üç' }, year:  2023, body: { en:`Third poem goes here.`, tr: `Üçüncü şiir buraya gelir.`
}
},
],
...
A third paragraph if needed.`, tr: `Makale metninizi buraya ekleyin. Bu, denemenin gövdesidir.

İkinci paragraf burada devam eder.

Gerekirse üçüncü paragraf.`} }, { id:    'article-2', title: { en: 'Article Title Two', tr: 'Makale Başlık İki' }, year:  2023, type:  { en: 'Criticism', tr: 'Eleştiri' }, body: { en:`Second article body goes here.`, tr: `İkinci makale metni buraya gelir.`
}
},
],
...
Write your text here. Each entry in this array becomes one page. Use blank lines between paragraphs.`, tr: `Bu kitabın ilk sayfasıdır.

Metninizi buraya yazın.`}, { en:`This is the second page.

Continue the text here.`, tr: `Bu ikinci sayfadır.

Metni burada sürdürün.`}, { en:`Third page.`, tr: `Üçüncü sayfa.`}, { en:`Fourth page.`, tr: `Dördüncü sayfa.`}, ] }, { id:    'book-2', title: { en: 'Book Title Two', tr: 'Kitap Başlık İki' }, year:  2024, cover: '', pages: [ { en:`First page of book two.`, tr: `İkinci kitabın ilk sayfası.`}, { en:`Second page of book two.`, tr: `İkinci kitabın ikinci sayfası.` },
]
},
],
